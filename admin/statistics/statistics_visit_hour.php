			...
			<div class="common_list">
				<nav class="list_category five">
					<ul>
						...
						<li class="curr"><span><a href="statistics_visit_hour.php?page=<?=$page . $page_params?>"><span>시간대별 방문자수</span></a></li>
