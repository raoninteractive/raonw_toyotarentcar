<?
	...
	$up_file_path            = "/upload/popup/";

	if (chkBlank($params['section'])) fnMsgJson(502, "팝업위치 값이 유효하지 않습니다.", "");
	...
	//팝업 상세정보
	$pop_view = $cls_popup->popup_view($params['idx']);
