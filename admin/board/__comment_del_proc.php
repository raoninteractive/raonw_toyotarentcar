<?
	...
	if (chkBlank($params['bbs_idx'])) fnMsgJson(502, "게시글 고유번호 값이 유효하지 않습니다.", "");
	if (chkBlank($params['idx'])) fnMsgJson(503, "댓글 고유번호 값이 유효하지 않습니다.", "");
	...
	//첨부파일 삭제
	if ($cls_board->comment_delete_proc($params) == 0) fnMsgJson(504, "댓글 삭제 처리중 오류가 발생되었습니다.", "");
?>
